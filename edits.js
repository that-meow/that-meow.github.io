async function manager(){
  ...
  for (let i = 0; i < stations.length; i++) { //looping through stations
    ...
    tableHeader.innerHTML = '<tr class="unbordered"><td colspan="4" class="unbordered"><h1>' + stations[i]["system-name"] + "</h1></td></tr><tr><td>Material</td><td>Amount</td><td>Economy</td><td>Possible buy locations</td></tr>"
